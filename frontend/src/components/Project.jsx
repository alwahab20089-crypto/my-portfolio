...
const projects = [
  ...
  {
    title: "NovaStudyAI",
    desc: "An AI-powered study assistant that helps students learn smarter with intelligent question answering, summaries, quizzes, flashcards, and personalized study support.",
    tags: [
      "React.js",
      "Vite",
      "Tailwind CSS",
...
function ProjectVisual({ project }) {
  ...
  return (
    <div
      ...
      style={{
        background: `linear-gradient(135deg, ${accent}22, #12141c)`,
      }}
    >
      <div
    ...
    >
      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        <div className="flex items-center justify-between gap-2 mb-3">
          <h3 className="aw-ui text-lg font-semibold text-[#e6e9f0]">
            {title}
          </h3>
        ...
        {/* Description */}
        <p className="aw-ui text-sm text-[#8b93a7] leading-relaxed mb-5">
          {desc}
        </p>
        ...
        <div className="mt-auto">
          {link ? (
            <a
              ...
              style={{
                background: `linear-gradient(90deg, ${accent}, #7aa2f7)`,
              }}
            >
              Live demo
  ...
  return (
    <section className="min-h-screen bg-[#0b0e14] text-white px-6 py-28">
      ...
      <div className="text-center mb-16">
        ...
        <h1 className="aw-ui text-5xl md:text-6xl font-bold mb-4">
          Projects
        </h1>
